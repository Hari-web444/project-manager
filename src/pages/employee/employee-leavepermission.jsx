...
function EmployeeLeavePermission() {
  ...
  const getUserActivityDatas = async (objStatus = '') => {
    setNeedLoading(true);
    ...
    try {
      ...
      if (response.status === 200) {
        setUserActivityDataList(result.data);
      } else {
  ...
  const paginatedUserActivity = userActivityDataList.slice(indexOfFirstUserActivity, indexOfLastUserActivity);
      ...
      <div className='header-div-el'>
        <div className='header-divpart-el'>
          <div className='d-flex gap-2'>
            <p className='mb-0 header-titlecount-el'>Leaves : {currentUserActivity.length || 0}</p>
            <p className='mb-0 header-titlecount-el'>permissions : {currentUserActivity.length || 0}</p>
          </div>
      ...
      <div className='body-div-el'>
        <div className='h-100 w-100 p-2 pb-0'>
          ...
          <div className='footer-tab-st'>
            ...
            <Pagination
              count={userActivityDataList.length}
              page={currentPage}
